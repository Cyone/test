...
public class TuringMachine {
    ...
    public TuringMachine(Set<Transition> transitions, Set<String> terminalStates, String initialState, String blankSymbol) {
 ...
 public enum Way{
    ...
    public List<String> runTM() { // Returns null if not in terminal state.
        ...
        while (transitions.containsKey(tsp)) { // While a matching transition exists.
        	lineNum++;
            System.out.println(lineNum+" "+this + " --- " + transitions.get(tsp));
        ...
        System.out.println(++lineNum+" "+this + " --- " + tsp);
    ...
    public static void main(String[] args) {
        ...
        TuringMachine machine = new TuringMachine(trans, term, init, blank);
 ...
 */
      ...
      /*  trans.add(new Transition(new StateTapeSymbolPair("a", "0"), new StateTapeSymbolPair("b", "1"), RIGHT));
        trans.add(new Transition(new StateTapeSymbolPair("a", "1"), new StateTapeSymbolPair("c", "1"), LEFT));
        trans.add(new Transition(new StateTapeSymbolPair("b", "0"), new StateTapeSymbolPair("c", "1"), RIGHT));
        trans.add(new Transition(new StateTapeSymbolPair("b", "1"), new StateTapeSymbolPair("b", "1"), RIGHT));
        trans.add(new Transition(new StateTapeSymbolPair("c", "0"), new StateTapeSymbolPair("d", "1"), RIGHT));
        trans.add(new Transition(new StateTapeSymbolPair("c", "1"), new StateTapeSymbolPair("e", "0"), LEFT));
        trans.add(new Transition(new StateTapeSymbolPair("d", "0"), new StateTapeSymbolPair("a", "1"), LEFT));
        trans.add(new Transition(new StateTapeSymbolPair("d", "1"), new StateTapeSymbolPair("d", "1"), LEFT));
        trans.add(new Transition(new StateTapeSymbolPair("e", "0"), new StateTapeSymbolPair("halt", "1"), RIGHT));
        trans.add(new Transition(new StateTapeSymbolPair("e", "1"), new StateTapeSymbolPair("a", "0"), LEFT));*/
        ...
        machine = new TuringMachine(trans, term, init, blank);
